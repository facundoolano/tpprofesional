...
\begin{figure}[tb]
\begin{center}
\includegraphics[width=1\columnwidth]{img/tpprof1.png}
...
\texttt{bundle.coffee}
\lstinputlisting{../invisible/src/bundle.coffee}
\texttt{config.coffee}
\lstinputlisting{../invisible/src/config.coffee}
\texttt{invisible.coffee}
\lstinputlisting{../invisible/src/invisible.coffee}
\texttt{routes.coffee}
\lstinputlisting{../invisible/src/routes.coffee}
\texttt{model/client.coffee}
\lstinputlisting{../invisible/src/model/client.coffee}
\texttt{model/common.coffee}
\lstinputlisting{../invisible/src/model/common.coffee}
\texttt{model/server.coffee}
\lstinputlisting{../invisible/src/model/server.coffee}
\texttt{model/socket.coffee}
\lstinputlisting{../invisible/src/model/socket.coffee}
